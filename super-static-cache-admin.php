...
<?php
	...
	if($docuroot==$homepath){
		...
		case strstr($software,"nginx"):
			$rewriterules='try_files $uri $uri/ /super-static-cache$uri /super-static-cache$uri/ /index.php';
			break;
		...
		switch ($software){
		case strstr($software,"nginx"):
			$rewriterules="location ~* $webdir(.*)$ {\n\ttry_files \$uri \$uri/ $webdir"."super-static-cache/$1 ".$webdir."super-static-cache/$1/ ".$webdir."index.php; \n}";
			break;
		case strstr($software,"apache"):
