    ...
    <div class="postbox">
        ...
        <div class="inside">
            <form method="post" action="">
                ...
                <div><label><?php _e('Purge Individual Posts','super_static_cache');?></label><input type="input" name="clearpostpagecache" placeholder="<?php _e('Please Enter the title or id of a post, separate with commas','super_static_cache');?>" size="80"/></div><br/>
